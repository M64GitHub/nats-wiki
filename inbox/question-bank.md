...
| 198 | Does JetStream have tiered storage — can sealed blocks be offloaded to S3 or a slower tier the way Kafka and Pulsar do it? | jetstream deploy | [gh#3871](https://github.com/nats-io/nats-server/discussions/3871) | design interop | [[stream]] — *How many streams, and what a second one costs* names the storage layer; the tiering answer itself is phase G1's row-144 page |
