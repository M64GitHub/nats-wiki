<!-- source: https://github.com/nats-io/nats-server/releases/tag/v2.10.25 (GitHub REST API, releases?per_page=100 — the same body `releases/tags/v2.10.25` returns) · fetched 2026-09-03 -->
# Release v2.10.25 — published 2025-01-23
