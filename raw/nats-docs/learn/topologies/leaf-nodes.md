<!-- source: https://docs.nats.io/learn/topologies/leaf-nodes.md · fetched 2026-08-31 · section: leaf-nodes -->
# Leaf nodes
...
The `urls` point at each hub server's leafnode listen port. Listing all three gives the leaf somewhere to reconnect if one hub server is down.
