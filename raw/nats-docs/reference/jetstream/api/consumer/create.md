<!-- source: https://docs.nats.io/reference/jetstream/api/consumer/create.md · fetched 2026-08-31 · section: create -->
# Create Consumer
...
typeconst: "io.nats.jetstream.api.v1.consumer\_create\_response"required
