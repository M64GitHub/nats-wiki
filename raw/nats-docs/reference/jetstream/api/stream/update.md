<!-- source: https://docs.nats.io/reference/jetstream/api/stream/update.md · fetched 2026-08-31 · section: update -->
# Update Stream
...
typeconst: "io.nats.jetstream.api.v1.stream\_update\_response"required
