<!-- source: https://docs.nats.io/reference/config/leafnodes/remotes/compression.md · fetched 2026-08-31 · section: compression -->
# compression

Hot Reloadable

Connections that need renegotiation (off->on, ->accept) are closed and reconnect.
...
| ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | ------------------- | ---------- |
| [`mode`](/reference/config/leafnodes/remotes/compression/mode.md)                     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `string`   | `accept`            | Yes        |
