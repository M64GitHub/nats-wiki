<!-- source: https://docs.nats.io/reference/config/leafnodes/compression.md · fetched 2026-08-31 · section: compression -->
# compression

Hot Reloadable

Existing leaf connections whose mode requires renegotiation (off->on, ->accept) are closed and reconnect.
