<!-- source: https://docs.nats.io/reference/config/cluster/tls/verify_cert_and_check_known_urls.md · fetched 2026-08-31 · section: verify_cert_and_check_known_urls -->
# verify\_cert\_and\_check\_known\_urls

Hot Reloadable

Evaluated when a route authorizes, i.e. for connections established after the reload.
