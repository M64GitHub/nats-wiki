<!-- source: https://docs.nats.io/reference/config/cluster/permissions/subscribe.md · fetched 2026-08-31 · section: subscribe -->
# subscribe
...
| ------------------------------------------------------------------- | ------------------------------------------------ | -------- | ------- | ---------- |
| [`allow`](/reference/config/cluster/permissions/subscribe/allow.md) | List of subjects that are allowed to the client. | `string` | -       | Yes        |
| [`deny`](/reference/config/cluster/permissions/subscribe/deny.md)   | List of subjects that are denied to the client.  | `string` | -       | Yes        |
