<!-- source: https://docs.nats.io/reference/config/websocket/tls/verify_cert_and_check_known_urls.md · fetched 2026-08-31 · section: verify_cert_and_check_known_urls -->
# verify\_cert\_and\_check\_known\_urls

Requires Restart

Only `false` parses, and it is then discarded (WebsocketOpts has no TLSCheckKnownURLs field).
