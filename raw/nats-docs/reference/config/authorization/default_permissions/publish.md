<!-- source: https://docs.nats.io/reference/config/authorization/default_permissions/publish.md · fetched 2026-08-31 · section: publish -->
# publish
...
| ------------------------------------------------------------------------------- | ------------------------------------------------ | -------- | ------- | ---------- |
| [`allow`](/reference/config/authorization/default_permissions/publish/allow.md) | List of subjects that are allowed to the client. | `string` | -       | Yes\*      |
| [`deny`](/reference/config/authorization/default_permissions/publish/deny.md)   | List of subjects that are denied to the client.  | `string` | -       | Yes\*      |
