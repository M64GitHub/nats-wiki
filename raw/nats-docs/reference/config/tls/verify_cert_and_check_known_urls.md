<!-- source: https://docs.nats.io/reference/config/tls/verify_cert_and_check_known_urls.md · fetched 2026-08-31 · section: verify_cert_and_check_known_urls -->
# verify\_cert\_and\_check\_known\_urls

Requires Restart

Only `false` parses in this context, and `false` has no stored effect.
