<!-- source: https://docs.nats.io/reference/config/resolver_tls/verify_cert_and_check_known_urls.md · fetched 2026-08-31 · section: verify_cert_and_check_known_urls -->
# verify\_cert\_and\_check\_known\_urls

Ignored Until Restart

Parsed then discarded; no effect on reload or restart.
