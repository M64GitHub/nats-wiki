<!-- source: https://docs.nats.io/reference/config/gateway/gateways/tls/verify_cert_and_check_known_urls.md · fetched 2026-08-31 · section: tls -->
# verify\_cert\_and\_check\_known\_urls

Ignored Until Restart

Silently discarded by parseGateways; only the top-level gateway{tls{}} block honours it.
