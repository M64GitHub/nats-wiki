<!-- source: https://docs.nats.io/reference/config/gateway/tls/verify_cert_and_check_known_urls.md · fetched 2026-08-31 · section: verify_cert_and_check_known_urls -->
