<!-- source: https://docs.nats.io/reference/config/gateway/authorization/default_permissions/allow_responses/expires.md · fetched 2026-08-31 · section: default_permissions -->
# expires
