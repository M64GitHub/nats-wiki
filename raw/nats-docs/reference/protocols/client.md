<!-- source: https://docs.nats.io/reference/protocols/client.md · fetched 2026-08-31 · section: client -->
# Client
...
| `ldm`             | If the server supports *Lame Duck Mode* notifications, and the current server has transitioned to lame duck, `ldm` will be set to `true`.                               | bool      | optional |
