<!-- source: https://docs.nats.io/reference/protocols/leafnode.md · fetched 2026-08-31 · section: leafnode -->
# Leafnode
...
* `-ERR 'Maximum Payload Exceeded'`: Message exceeds max\_payload
