<!-- source: https://docs.nats.io/reference/protocols/route.md · fetched 2026-08-31 · section: route -->
# Route

Route connections are used to form a cluster of NATS servers. The route protocol is very similar to the [client protocol](/reference/protocols/client.md). In the context of a cluster, it can be helpful to visualize a server being a proxy operating on behalf of its connected clients, subscribing, unsubscribing, sending and receiving messages.
