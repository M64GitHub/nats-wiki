<!-- source: https://docs.nats.io/release-notes.md · fetched 2026-08-31 · section: release-notes -->
...
| ------- | ----------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | ----------------------------------------------------------- |
| 2.14    | [Upgrade to 2.14](/release-notes/upgrade-to-2.14.md)                                                              | [GitHub](https://github.com/nats-io/nats-server/releases/tag/v2.14.0) | [Blog post](https://nats.io/blog/nats-server-2.14-release/) |
| 2.12    | [Upgrade to 2.12](/release-notes/upgrade-to-2.12.md)                                                              | [GitHub](https://github.com/nats-io/nats-server/releases/tag/v2.12.0) | [Blog post](https://nats.io/blog/nats-server-2.12-release/) |
